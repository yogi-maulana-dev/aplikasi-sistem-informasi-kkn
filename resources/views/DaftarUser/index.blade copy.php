    ...
    <div class="wrapper">
      <section class="login-content">
         <div class="row m-0 align-items-center bg-white vh-580">
               ...
               <img src="/admin/images/auth/projectyai.png" class="img-fluid gradient-main animated-scaleX" alt="images" loading="lazy">
            </div>
            <div class="col-md-6">
...
@endif
                           ...
                           <form method="post" action="{{ route('pendaftaraan.simpan') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="npm" class="form-control border-success" id="npm" placeholder=" " value="{{ old('npm') }}">
                                        @error('npm')
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="namalengkap" class="form-control border-success" id="namalengkap" placeholder=" " value="{{ old('namalengkap') }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="email" class="form-label">Email</label>
                                        <input type="email" name="email" class="form-control border-success" id="email" placeholder=" " value="{{ old('email') }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <label class="form-label" for="jk">Jenis Kelamin</label>
                                    <select name="jk" class="form-select border-success @error('jk') is-invalid @enderror" data-trigger name="jk" id="jk">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="nohp" class="form-control border-success @error('nohp') is-invalid @enderror" id="nohp" value="{{ old('nohp') }}">
                                        @error('nohp')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control border-success @error('gambar') is-invalid @enderror" name="gambar" type="file" id="gambar">
                                        @error('gambar')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="fakultas" class="form-select border-success @error('fakultas') is-invalid @enderror" data-trigger id="fakultas">
                                            <option value="">Pilih</option>
                                            @foreach ($fakultasx as $fakultasItem)
                                            <option value="{{ $fakultasItem->nama }}">{{ $fakultasItem->nama }}</option>
                                            @endforeach
                                        </select>
                                        @error('fakultas')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="gambarbayar" class="form-label custom-file-input">Upload Bukti Pembayaran</label>
                                        <input class="form-control border-success @error('gambarbayar') is-invalid @enderror" name="gambarbayar" type="file" id="gambarbayar">
                                        @error('gambarbayar')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password" class="form-control border-success" id="password" placeholder=" ">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="confirm-password" class="form-label">Confirm Password</label>
                                        <input type="password" name="password_confirmation" class="form-control border-success" id="confirm-password" placeholder=" ">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <label class="form-label" for="baju">Ukuran Baju</label>
                                    <select name="sizebaju" class="form-select border-success @error('sizebaju') is-invalid @enderror" data-trigger name="sizebaju" id="sizebaju">
                        ...
                        <p class="mt-3 text-center">
                            Silakan Login Jika Sudah Memiliki Akun <a href="sign-in.html" class="text-underline">Sign In</a>
                        </p>

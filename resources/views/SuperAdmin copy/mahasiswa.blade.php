                                                    ...
                                                    <td style="max-width: 100px;">
                                                        <div class="grid grid-cols-3 gap-4">
                                                            <a data-fslightbox="gallery"
                                                                href="{{ url($mahasiswa->gambarbayar) }}">
                                                                <img src="{{ url($mahasiswa->gambarbayar) }}"
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group" aria-label="Aksi">
                                                            <button type="button" class="btn btn-sm btn-warning"
                                                                ...
                                                                data-bs-target="#lihatMahasiswaModal{{ $mahasiswa->id }}">
                                                                Lihat Lengkap
                                                            </button>
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-primary cetak-btn d-none d-sm-inline" data-id="{{ $mahasiswa->id }}">
                                                                Cetak Data
                                                            </button> <!-- Hide on small screens -->
                                                            <button type="button" class="btn btn-sm btn-success"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#aktif{{ $mahasiswa->id }}">
                                                                Aktifkan Akun
                                                            </button>
                                                        </div>
                                                    </td>

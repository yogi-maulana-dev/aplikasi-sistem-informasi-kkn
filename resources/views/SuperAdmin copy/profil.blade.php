                                        ...
                                        <ul class="iq-header-sub-menu list-unstyled collapse" id="allPagesData">
                                                    ...
                                                    <li class="nav-item">
                                                        ...
                                                        <ul aria-expanded="false"
                                                            ...
                                                            <li class="nav-item"><a class="nav-link " href="#"
                                                                    ...
                                                                    data-bs-target="#staticBackdrop">Sign In</a></li>
                                                            <li class="nav-item"><a class="nav-link " href="#"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#staticBackdrop1">Sign Up</a></li>
                                                        </ul>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link menu-arrow" data-bs-toggle="collapse"
                                            ...
                                            <li class="nav-item">
                                                ...
                                                <ul aria-expanded="false"
                                                    ...
                                                    <li class="nav-item"><a class="nav-link " href="user-add.html">User
                                                            Add</a></li>
                                                    <li class="nav-item"><a class="nav-link " href="user-list.html">User
                                                            List</a></li>
                                                </ul>
                                            </li>
                                            <li class="nav-item">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <div>
                                            <img src="/admin/images/avatars/01.png" alt="profile-img"

...
class LoginSuperAdminController extends Controller
{
    ...
    {
        //
        return view('LoginSuperAdmin.index');
    }
     ...
     public function loginAction(Request $request)
{
    ...
    if ($field && Auth::guard('superadmin')->attempt([$field => $credentials['login_identifier'], 'password' => $credentials['password']])) {
    ...
    {
        Auth::guard('superadmin')->logout(); // Use the 'superadmin' guard for logout
